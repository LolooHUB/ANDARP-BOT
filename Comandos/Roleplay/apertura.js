...
module.exports = {
    ...
    // ESTA FUNCIÓN MANEJA TODOS LOS EVENTOS DE ESTE COMANDO (MODALES Y BOTONES)
    async handleAperturaInteractions(interaction) {
        const { customId, guild, user, fields } = interaction;
        const pingVotacion = "<@&1476765007344828590>"; // Ping Spoilers/Votación
        ...
        if (['vote_yes', 'vote_late', 'vote_no'].includes(customId)) {
            const state = (await docRef.get()).data();
            ...
            if (customId === 'vote_yes') {
                ...
                // VERIFICAR SI SE ALCANZA EL MÍNIMO PARA ABRIR
        ...
        if (customId === 'modal_resumen_cierre') {
            ...
            // Guardar en logs y base de datos
